<script>
  ...
  function changeSVGColor(event) {
    colorSVG.set(event.target.value);
  }
</script>
...
<div
  ...
  <div class="absolute right-0 bottom-0 mr-4 mb-4 flex">
    <div class="flex mr-5">
      <!-- <label for="colorpicker"><img src="/colorpicker2000.png" alt="colorPicker" width="30" height="30" /></label> -->
      <input type="color" id="colorpicker" on:change={changeSVGColor} value="#000000">
    </div>
    <button
      on:click={cancel}
